...
class Hand3 extends ObjetoQueRota
{
	...
	Hilo_Extend hilo_rite;
	Hilo_Extend hilo_left;
  ...
  boolean flag=true;
	...
	Hand3(float valor_1, float valor_2, String nombre)
	{
...

	{
		...
		Cylinder cil = new Cylinder (cil_rad,cil_high);
	...
	public void cerrar(int valor)
	{
		...
		hilo_left = new Hilo_Extend (true,tg_box_left_t,  valor_inicial_l,valor_final_l);
		hilo_rite = new Hilo_Extend (false,tg_box_rite_t, valor_final_r,valor_inicial_r);
	...
	
	{
		...
		hilo_left = new Hilo_Extend (false,tg_box_left_t,  valor_final_l,valor_inicial_l);
		
		hilo_rite = new Hilo_Extend (true,tg_box_rite_t, valor_inicial_r,valor_final_r);
