...
class Joint6 extends ObjetoQueRota
{
	...
	Joint6(float valor_1, float valor_2, float valor_3, String nombre)
	{
	...
	void crearJoint()
	{
		...
		hc_left = new HalfCircle(rad_hc,high_hc,apariencia);
		hc_rite = new HalfCircle(rad_hc,high_hc,apariencia);
